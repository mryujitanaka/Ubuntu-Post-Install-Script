...
<p>Above the license, my script is based in four freedoms (inspired by the <a href="https://mediatemple.net/blog/web-development-tech/wordpress-philosophy-four-freedoms/">WordPress Philosophy</a>):</p>
<ul> 
